...
import { newSite } from '@/services/LandingPageServices';
import { generateInitialState } from '@mediapartners/shared-types/types/panel/cms/WebsiteModel';
...
const CreateNewSite = () => {
  ...
  return (
    <div>
      <SharedButton buttonType={ButtonType.PRIMARY} label="Ny sida" handleClick={() => setIsOpen(true)} />
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
        {success ? (
          <div>New site with the name {data.url} was created, congratz! Get that moneyyy yoo$$$ </div>
        ) : (
          <>
